...
<!-- //for-mobile-apps -->
<link href="assets/default/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="assets/default/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
<script type="text/javascript" src="assets/default/js/jquery-2.1.4.min.js"></script>
<!-- //js -->
...
<script type="text/javascript" src="assets/default/js/move-top.js"></script>
<script type="text/javascript" src="assets/default/js/easing.js"></script>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<a href="index.php"> <img style="width: 50%; padding-top:10px; padding-bottom:10px " src="resource/default/images/langitinspirasi.png"></a>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--shylock">
						<ul class="nav navbar-nav link-effect-7" id="link-effect-7">
							...
							<li><a href="#" data-hover="Short Codes">Short Codes</a></li>
							<li><a href="#" data-hover="Mail Us">Mail Us</a></li>
						</ul>
					</nav>
				</div>
			</nav>	
		...
		<div class="container">
			...
			<div class="clearfix"> </div>
				<!-- Starts-Number-Scroller-Animation-JavaScript -->
					...
					<script src="assets/default/js/counterup.min.js"></script> 
					<script>
						jQuery(document).ready(function( $ ) {
							$('.counter').counterUp({
								delay: 20,
